...
- result_text MUST end with a one-line next step ("Adam will email you in the next day or two." OR "The fastest move is ringing the demo line on plus one six six one seven six four three two one two." OR "Drop your invoice into the Doc Ops sample on https://callmeie.ie/docs/ and you'll see the confidence-gated output for yourself.").
